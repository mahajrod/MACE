...
from MACE.Routines import StatsVCF, VisualizationRoutines
...
cluster_df = StatsVCF.test_clustering_thresholds(variants.records, method=args.distance,
                                                 ...
                                                 threshold_step=args.threshold_step,)
print("Drawing...")
VisualizationRoutines.plot_clustering_threshold_tests(cluster_df, output_prefix,
                                                      scaffold_order_list=args.scaffold_orderlist,
