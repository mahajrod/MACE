...
class HorizontalTrackGroupStyle:
...
default_horizontal_track_group_style = HorizontalTrackGroupStyle()
italic_horizontal_track_group_style = HorizontalTrackGroupStyle(label_fontstyle='italic')
