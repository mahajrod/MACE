...
from MACE.Visualize.Styles.HorizontalTrackGroup import HorizontalTrackGroupStyle, default_horizontal_track_group_style
...
class VerticalTrackGroup(OrderedDict):
    ...
    def __init__(self, tracks=None, y_start=None, x_start=0, x_end=1, style=default_horizontal_track_group_style,
